        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p className="mt-2 text-lg/8 text-gray-600">I'd love to share with you the challenges I've faced and some of the strategies that have helped me overcome them.</p>
                </div>
                <div
